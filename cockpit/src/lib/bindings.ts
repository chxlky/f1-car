...
export const commands = {
    ...
    async isDiscoveryRunning(): Promise<Result<boolean, DiscoveryError>> {
        try {
    ...
    async startJoystickServiceCommand(
        wsPort: number,
        piAddr: string
        ...
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("start_joystick_service_command", { wsPort, piAddr })
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async stopJoystickServiceCommand(): Promise<Result<null, string>> {
        try {
            return { status: "ok", data: await TAURI_INVOKE("stop_joystick_service_command") };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
        }
